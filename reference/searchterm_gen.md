...
Construct search term for searching GenBank's nucleotide database.
Limits the maximum size of sequences, avoids whole genome shotguns,
predicted, unverified and synthetic sequences.
