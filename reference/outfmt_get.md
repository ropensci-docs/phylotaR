...
Depending on operating system, BLAST may or may not require "" around
`outfmt`. This function will run a micro BLAST analysis to test. It will
return the `outfmt` for use in `blastn_run`.
