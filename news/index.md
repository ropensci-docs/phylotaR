...
There are a lot of CRAN submission problems pointed by Victoria Wimmer
and I have no patience to handle them, I am not able to release it to
CRAN.
...
- New parameter: `db_only`, avoid downloads by fetching exclusively from
  `restez` database
- Excluding Transcriptome Shotgun Assembly sequences, making downloading
  faster
...
- Now works with
  [`restez`](https://ropensci.github.io/restez/articles/4_phylotar.html)
